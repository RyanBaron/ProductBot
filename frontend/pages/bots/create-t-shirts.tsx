  ...
  return (
    <div className="siteWrapper bg-pattern-primary flex flex-col min-h-screen">
      <Head>
        ...
        <meta name="description" content="Create and order your own custom t-shirt with AI." />
      </Head>
          ...
          <div className="container flex-grow">
            ...
            <div className="flex flex-wrap bg-gray-400 justify-start items-start h-full">
              <div className="w-full md:w-1/3">
                T-Shirt Bot - Left Col
              </div>
              <div className="w-full md:w-2/3">
                T-Shirt Bot - Right Column
              </div>
            </div>
          </div>
        </div>
